                ...
                <div className="mb-6">
                  <label className="block">
                    ...
                    <input
                      ...
                      className="w-full rounded-2xl border border-white/10 bg-[#081120] px-4 py-3 text-sm text-white outline-none transition placeholder:text-white/30 focus:border-cyan-300/40"
                    />
