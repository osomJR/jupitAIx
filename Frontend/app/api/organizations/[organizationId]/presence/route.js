...
export async function GET(req, context) {
  ...
  return proxyJsonToBackend({
    backendPath: withSearchParams(
      req,
      `/api/v1/organizations/${encodeURIComponent(organizationId)}/presence`,
    ),
    method: "GET",
  });
}
...
export async function POST(req, context) {
  ...
  return proxyJsonToBackend({
    backendPath: `/api/v1/organizations/${encodeURIComponent(organizationId)}/presence`,
    method: "POST",
    body,
  });
}
